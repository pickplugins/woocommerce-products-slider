											...
											<PanelBody
													...
													<>
														<PanelRow className="mb-4 flex-col items-start gap-2">
															<label
																for=""
																className="font-medium text-slate-900 ">
																{__("Element ID/Class", "woocommerce-products-slider")}
															</label>
															<InputControl
																className="mr-2"
												...
												{id == "dateCountdownExpired" && (
													<>
														...
														/>
														{/* <PanelRow className='mb-4'>
                                <label for=""  className="font-medium text-slate-900 " >{__('Element ID/Class', "woocommerce-products-slider")}</label>
                                <InputControl
                                  className='mr-2'
                                  placeholder=".element or #elementId"
                                  once={item.value}
