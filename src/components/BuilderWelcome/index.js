...
function Html(props) {
	...
	const freeVsProArgs = [
		{
			feature: "View Type - WCPS Grid",
			free: true,
			pro: true,
		},
		{
			feature: "View Type - WCPS Slider",
			free: true,
			pro: true,
		},
		{
			feature: "View Type - WCPS Masonry",
			free: false,
			pro: true,
		},
		{
					...
					<div className="flex gap-4 items-start flex-wrap mt-10 px-10">
						<div className="flex-1 flex flex-col gap-3 p-[40px] max-w-[70%] bg-white rounded-md shadow-md">
							...
							<p className="text-gray-500 text-[14px]">
								Thanks for installing WCPS plugin! Watch this video to get
								started.
							</p>
							<iframe
								width="100%"
						...
						<div className="grid md:grid-cols-1 grid-cols-3 content-between md:max-w-[30%] max-w-full gap-3 text-gray-800">
							<div className="flex flex-col gap-3 bg-white p-[20px] rounded-md shadow-md">
								...
								<p>
									Watch our videos to see how the WCPS works in real-world
									projects!
								</p>
								<a
									target="_blank"
