...
function Html(props) {
	...
	var [filterable, setfilterable] = useState(wcpsData.filterable);
	var [activeFilter, setactiveFilter] = useState(wcpsData.activeFilter);
	var [filterGroupWrap, setfilterGroupWrap] = useState(
		wcpsData.filterGroupWrap
	);
	var [filterGroup, setfilterGroup] = useState(wcpsData.filterGroup);
	...
	useEffect(() => {
		var wcpsDataX = { ...wcpsData };
		wcpsDataX.accOptions = accOptions;
		setwcpsData(wcpsDataX);
	}, [accOptions]);
	...
	useEffect(() => {
		var wcpsDataX = { ...wcpsData };
		wcpsDataX.filterable = filterable;
		setwcpsData(wcpsDataX);
	}, [filterable]);
	...
	var termQueryArgs = {
		taxonomy: {
			...
			id: "taxonomy",
			label: __("Taxonomy", "woocommerce-products-slider"),
				...
				<>
					...
					<PanelBody title="Navs & Labels" initialOpen={false}>
						...
						<PanelBody
							...
							title={
								<span className="flex justify-between w-full gap-2">
									<span>{__("Label Icon", "woocommerce-products-slider")}</span>
									{isProFeature ? (
										<span
							...
							<PGtabs
								...
								<PGtab name="options">
									<PanelRow>
										<label htmlFor="" className="font-medium text-slate-900 ">
											{__("Choose Label Icon", "woocommerce-products-slider")}
										</label>
										<PGIconPicker
									...
									<PanelRow>
										<label htmlFor="" className="font-medium text-slate-900 ">
											{__("Icon position", "woocommerce-products-slider")}
										</label>
										<SelectControl
											label=""
											...
											options={[
												{
													label: __("Choose Position", "woocommerce-products-slider"),
													value: "",
												},
												{
													label: __("Before Label", "woocommerce-products-slider"),
													value: "beforeLabel",
												},
												{
													label: __("After Label", "woocommerce-products-slider"),
													value: "afterLabel",
												},
												{
													label: __("Before Label Text", "woocommerce-products-slider"),
													value: "beforeLabelText",
												},
												{
													label: __("After Label Text", "woocommerce-products-slider"),
						...
						<PanelBody
							...
							title={
								<span className="flex justify-between w-full gap-2">
									<span>{__("Label Counter", "woocommerce-products-slider")}</span>
									{isProFeature ? (
										<span
											className="bg-amber-500 px-2 py-1  no-underline rounded-sm  cursor-pointer text-white "
											onClick={(ev) => {
							...
							<PGtabs
								...
								<PGtab name="options">
									<PanelRow>
										<label htmlFor="" className="font-medium text-slate-900 ">
											{__("Counter position", "woocommerce-products-slider")}
										</label>
										<SelectControl
											label=""
											...
											options={[
												...
												{ label: __("Left", "woocommerce-products-slider"), value: "left" },
												{ label: __("Right", "woocommerce-products-slider"), value: "right" },
												{
													label: __("Before Label Text", "woocommerce-products-slider"),
													value: "beforeLabelText",
												},
						...
						<PanelBody
							...
							<PGtabs
								...
								<PGtab name="options">
									...
									<div className="flex  my-5  justify-between items-center">
										<label className="" htmlFor="">
											{__("Animation duration", "woocommerce-products-slider")}
										</label>
										<PGinputText
