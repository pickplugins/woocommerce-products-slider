...
function Html(props) {
	...
	function senMail() {
		...
		var postData = {
			...
			subject: '#WCPS Support - ' + searchPrams.title,
			body: htmlBody,
	...
	return (
		<div id="requestTemplate" className="pg-setting-input-text">
			...
			<div className='flex items-end justify-end gap-2'>
				<a className='bg-slate-400 px-4 py-2 rounded-sm' target='_blank' href="https://wordpress.org/support/plugin/woocommerce-products-slider/#new-topic-0">Create Ticket at wordpress.org</a>
