...
function Html(props) {
	...
	var args = {
		top: { label: __("Top", "woocommerce-products-slider"), value: "top" },
		bottom: { label: __("Bottom", "woocommerce-products-slider"), value: "bottom" },
		...
		<div className="flex justify-between items-center">
			<Dropdown
				...
				renderToggle={({ isOpen, onToggle }) => (
					<Button title={__("Empty Cells", "woocommerce-products-slider")} onClick={onToggle} aria-expanded={isOpen}>
