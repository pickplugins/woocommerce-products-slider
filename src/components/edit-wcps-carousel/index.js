...
function Html(props) {
	...
	var [itemQueryArgs, setitemQueryArgs] = useState(wcpsData.itemQueryArgs);
	...
	var [paginationItem, setpaginationItem] = useState(wcpsData.paginationItem);
	var [paginationItemActive, setpaginationItemActive] = useState(wcpsData.paginationItemActive);
	...
	var [sliderOptionsRes, setsliderOptionsRes] = useState(wcpsData?.sliderOptionsRes);
