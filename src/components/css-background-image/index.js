...
function Html(props) {
  ...
  var typeArgs = {
    url: { label: __('Image URL', "woocommerce-products-slider"), id: 'url' },
    //conicGradient: { label: 'Conic Gradient', id: 'conicGradient' },
    linearGradient: { label: __('Linear Gradient', "woocommerce-products-slider"), id: 'linearGradient' },
    radialGradient: { label: __('Radial Gradient', "woocommerce-products-slider"), id: 'radialGradient' },
  ...
  return (
    <div>
      <div className="my-4">
        <PGDropdown position="bottom right" variant="secondary" options={typeArgs} buttonTitle={__("Add", "woocommerce-products-slider")} onChange={(option, index) => {
          if (option.id == 'url') {
