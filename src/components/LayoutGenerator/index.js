...
const elementTemplates = {
	...
	productSaleCount: {
		type: "productSaleCount",
		label: "Product Sale Count",
		options: { prefix: "" },
		styles: {},
	},
	productSaleBadge: {
		type: "productSaleBadge",
		label: "Product Sale Badge",
		options: { prefix: "" },
		styles: {},
	},
	productFeaturedBadge: {
		type: "productFeaturedBadge",
		label: "Product Featured Badge",
		options: { prefix: "" },
		styles: {},
	},
	productOnsaleBadge: {
		type: "productOnsaleBadge",
		label: "Product On-sale Badge",
		options: { prefix: "" },
		styles: {},
	},
	productAddToCart: {
	...
	postTaxonomies: {
		...
		options: { taxonomy: "", maxCount: "", separator: "" },
		styles: {},
	},
...
export default function LayoutGenerator({ onChange, layouts, postData }) {
	...
	const handleTemplateAdd = (template, parentId = null) => {
		const newItem = {
			...
			selectors: template.selectors ? template.selectors : null,
		};
	...
	return (
		<div className="flex gap-3 bg-gray-100">
			...
			<div className="flex-1 justify-between max-w-[450px] w-full min-h-full ">
				...
				<div id={`wcps-${postId}`} className="p-3 overflow-hidden">
					<ReactSortable
						list={blocks}
